...
const MenHeader = () => {
  ...
  return (
    <div className="h-[26rem] w-full bg-gradient-to-r from-yellow-100 via-pink-100 to-blue-100 flex items-center justify-between px-6 sm:px-12 rounded-2xl shadow-lg">
  {/* LEFT TEXT CONTENT */}
      <div
